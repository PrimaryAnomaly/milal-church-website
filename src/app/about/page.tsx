...
export default async function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-14">
      ...
      <section className="mt-6 rounded-xl border-2 border-dashed border-accent bg-accent-soft/40 p-6">
        <PlaceholderBanner label={t.common.placeholderBanner} />
        <h2 className="mt-3 text-lg font-semibold text-foreground">{t.about.pastorHeading}</h2>
        ...
        <p className="mt-3 text-xs font-semibold text-accent">{t.about.pastorVerify}</p>
      </section>
